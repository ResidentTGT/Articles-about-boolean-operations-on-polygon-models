...
<img src="./media/image1.png" width="340" height="319" align="left"/>Рис.1. Аппроксимация объекта с помощью четырех пространственных структур: AABB(а); сферы(б); OBB(в); k-dop(k=8)(г)<br> <br clear="left"/>
